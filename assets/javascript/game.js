function reset() {
	window.gameObj = {
	    ...
	    {
	        name: 'Storm Trooper',
	        visual: 'assets/images/storm_trooper.jpg',
	        healthPoints: 160, 
	        attackPower: 10,
	    ...
	    {
	        name: 'Chewbacca',
	        visual: 'assets/images/chewbacca.jpg',
	        healthPoints: 180, 
	        attackPower: 7,
	    ...
	    {
	        name: 'Darth Vader',
	        visual: 'assets/images/darth_vadar.jpg',
	        healthPoints: 180,
	        attackPower: 15,
	    ...
	    },
	    {
	        ...
	        visual: 'assets/images/General-Grievous.jpg',
	        healthPoints: 110,
	        attackPower: 12,
	        counterAttackPower: 20,
	    },
	   	{
	        name: 'Obi Wan Kenobi',
	        visual: 'assets/images/Obi_Wan_Kenobi.jpg',
	        healthPoints: 100,
	        attackPower: 12,
...
$(document).ready(function() {
	...
	// gets the link for the theme song to be played in the background
     ...
     audioElement.setAttribute('src', 'assets/audio/starwars.mp3');
	...
	function render() {
		...
		if (gameObj.wounded){
			$('#attackText').html("You're Jacked Up. GAME OVER!");
		}
